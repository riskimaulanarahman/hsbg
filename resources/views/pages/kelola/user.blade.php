...
@section('content')
		...
		<div class="panel panel-info">
			...
			<div class="panel-heading">
				<h4 class="panel-title">Kelola - User </h4>
...
<script>
    ...
    let store = new DevExpress.data.CustomStore({
        key: "id",
        load: function() {
            return sendRequest(apiurl + "/kelola-user");
        },
        insert: function(values) {
            return sendRequest(apiurl + "/kelola-user", "POST", values);
        },
        update: function(key, values) {
            return sendRequest(apiurl + "/kelola-user/"+key, "PUT", values);
        },
        remove: function(key) {
            return sendRequest(apiurl + "/kelola-user/"+key, "DELETE");
        }
    });
    ...
    RoleType = [{id:1,roletype:"admin"},{id:2,roletype:"staff"},{id:3,roletype:"finance"}];
    // attribute
